...
function Contact() {
    ...
    return (
        <PageLayout>
            <Header />
            <span className="text-darkerSky font-bold text-3xl text-center mt-1 2xl:mt-2">Kontakt</span>
            <div className="flex justify-center items-center">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 p-10">
                    ...
                    <div className="flex flex-col justify-center sm:ml-10 text-base lg:text-lg">
                        <div className="mb-4 text-mediumSky mt-5 inline-block">

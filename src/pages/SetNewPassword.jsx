        ...
        <PageLayout>
            ...
            <div className="flex justify-center">
                <div
                    ...
                    <div
                        className="w-full h-24 bg-mediumSky opacity-50 rounded-tl-[10px] rounded-tr-[10px] flex justify-center items-center text-center">
                    ...
                    <form className="flex flex-col gap-0 w-full justify-items-center p-10">
                        <label className="font-bold text-mediumSky text-lg mt-[30px] self-start ml-2">Lozinka:</label>
                        ...
                        <label
                            className="font-bold text-mediumSky text-lg mt-[15px] self-start ml-2">Potvrdi
                            lozinku:</label>
                        <div className="relative">
                        ...
                        <button
                            className="sm:w-1/2 mx-auto bg-mediumSky text-white font-semibold px-5 py-3 my-10 rounded-[5px]"

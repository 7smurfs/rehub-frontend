...
function AppointmentCalendar() {
    ...
    return (<div className={"h-full row-span-3 col-span-2 bg-sky-100 rounded-[5px]"}>
...
function AppointmentList() {
    ...
    return (<div className={"h-full row-span-1 col-span-1 bg-sky-100 rounded-[5px]"}>
...
function RoomList() {
    ...
    return (<div className={"row-span-1 col-span-1 bg-sky-100 rounded-[5px]"}>
        <div className={'h-10 flex justify-center items-center'}>
...
function PatientAndTherapyList() {
    ...
    useEffect(() => {
        api.get('/employee/accountable/therapies', {
            ...
            setPatientAndTherapyList(res.data);
        }).catch(() => toast.error('Dogodila se pogreška.'));
    }, []);
